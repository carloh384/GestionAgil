        ...
        <div class="overlay">
            ...
            <div class="wrapper">
                ...
                <div class="form-section">
                    ...
                    <h3>Inicia sesi&oacute;n con tu cuenta!</h3>

                    <!-- formulario login -->
                    <form action="../controller/funciones.php" method="post" class="signin-form">
                        <div class="form-input">
                            <input type="hidden" name="funcion" value="ingreso" />
                            <input type="email" placeholder="Correo" required="" name="correo_usuario">
                        </div>
                        <div class="form-input">
                            <input type="Password" placeholder="Contrase&ntilde;a" required="" name="contrasena_usuario">
                        </div>

                        <label class="check-remaind">
                            <input type="checkbox">
                            <span class="checkmark"></span>
                            <p class="remember">Recuerdame</p>
                        </label>


                        <button type="submit" class="mi-boton">Iniciar sesi&oacute;n</button>

                        <div class="new-signup">
                            <!-- boton modal recuperar -->
                            <br>
                            <button type="button" class="mi-boton2" id="myBtn">&#191;Olvidaste tu contrase&ntilde;a?</button>
                            <br>
                        </div>
                    </form>

                    <br>
                    <button type="button" class="mi-boton3" onclick="window.location.href='registro.php'">¿No tienes cuenta? Regístrate</button>
                    <br>
                </div>
            </div>
        </div>
